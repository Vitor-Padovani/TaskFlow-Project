...
import com.padovani.tasks.domain.entities.TaskPriority;
import com.padovani.tasks.domain.entities.TaskStatus;
import com.padovani.tasks.repositories.TaskListRepository;
import com.padovani.tasks.repositories.TaskRepository;
import com.padovani.tasks.services.TaskService;
...
public class TaskServiceImpl implements TaskService {
    ...
    public Task updateTask(UUID taskListId, UUID taskId, Task task) {
        ...
        if (!Objects.equals(taskId, task.getId())) {
            throw new IllegalArgumentException("TaskIDs do not match!");
        }
